...
const CADENCIA = [
  ...
  },
  {
    ...
    a: ["Empezamos con valor y confianza, no con «compra ya». La cuenta está fría: pedir conversión a una audiencia que no interactúa hace meses es como pedir matrimonio en la primera cita. Primero reabrimos conversación, damos valor y generamos confianza — <b>recién entonces</b> revelamos y convertimos."],
  },
  {
  ...
  return (
    <div className={s.root}>
      ...
      <div className={s.wrap}>
        ...
        <h2 className={s.sec}><span className={s.n}>03</span> Cómo pensamos la cadencia <span className={s.hint}>— cuestionando cada decisión, no solo llenando casillas</span></h2>
        <div className={s.qa}>
          {CADENCIA.map((item) => (
        ...
        <h2 className={s.sec}><span className={s.n}>04</span> Matriz 7 días <span className={s.hint}>— editable · filtra por fase · se guarda en tu navegador</span></h2>
        <MatrixEditor />
        ...
        <div className={s.rhythm}>
          ...
          <p><b>Alineación con la agencia:</b> nosotros llevamos orgánico y comunidad; la agencia, pauta y performance — sobre el mismo link con seguimiento. Sync semanal y reporte mensual (alcance, guardados, comentarios, clics a la lista, registros).</p>
        </div>
