...
const DEFAULT: Row[] = [
  { id: "d7", cd: "D-7", date: "7/8", dow: "Mié", ph: "Despertar", type: "Reel", obj: "Reactivar la conversación",
    ...
    hook: "Llevamos 6 años rematando autos. Y eso se nos quedó chico.", cta: "¿Qué crees que se viene? Tíralo en comentarios",
  ...
  { id: "d6", cd: "D-6", date: "7/9", dow: "Jue", ph: "Despertar", type: "Carrusel", obj: "Dar valor / autoridad",
    ...
    hook: "6 años en subastas nos enseñaron cómo NO botar tu plata al ofertar", cta: "Guárdalo para tu próxima puja",
  ...
  { id: "d5", cd: "D-5", date: "7/10", dow: "Vie", ph: "Despertar", type: "Reel", obj: "Construir confianza",
    ...
    hook: "Arrancamos con autos. Hoy ya no somos solo eso.", cta: "¿Qué te gustaría rematar? Tíralo abajo",
  ...
  { id: "d4", cd: "D-4", date: "7/11", dow: "Sáb", ph: "Hype", type: "Reel", obj: "Enseñar la mecánica / mostrar el upgrade",
    ...
    hook: "Ofertar en la nueva VMC te toma 30 segundos. Te muestro.", cta: "Guárdalo para el 15/7",
  ...
  { id: "d3", cd: "D-3", date: "7/12", dow: "Dom", ph: "Hype", type: "Carrusel", obj: "Prueba social + FOMO",
    ...
    hook: "Miles ya se llevaron su auto acá. Sin comisiones, sin intermediarios.", cta: "Entra a la lista de espera antes del 15/7 (un solo link)",
  ...
  { id: "d2", cd: "D-2", date: "7/13", dow: "Lun", ph: "Reveal", type: "Reel", obj: "Reveal total",
    ...
    hook: "Seguimos siendo VMC. Solo que ahora rematas mucho más que autos.", cta: "El 15/7 abre todo. Regístrate hoy y entra primero.",
  ...
  { id: "dday", cd: "D-DAY", date: "7/15", dow: "Mié", ph: "Lanzamiento", type: "Reel", dday: true, obj: "Conversión",
    ...
    hook: "Ya está abierto. Entra y haz tu primera oferta.", cta: "Regístrate y oferta hoy (un solo link)",
